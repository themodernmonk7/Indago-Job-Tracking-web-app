...
const Sidebar = () => {
  return (
    <>
      <main className="flex ">
        <section className="w-1/3 xl:w-1/5 h-screen space-y-16 bg-gray-100/50">
          {/* Logo title */}
          <div className=" w-3/4 py-10 font-bold">
          ...
          <div className="flex flex-col space-y-8 font-semibold">
            <a
              href="#"
              className="flex justify-center items-center   bg-[#f53465] rounded-r-xl text-white py-5 w-3/4"
            >
              <span className=" px-4">
                <svg
